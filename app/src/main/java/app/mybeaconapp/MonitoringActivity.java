...
/**
 * Created by Giacomo on 02/02/2018.
 */
    ...
    public void onBeaconServiceConnect() {
        beaconManager.addMonitorNotifier(new MonitorNotifier() {
            ...
            public void didEnterRegion(Region region) {
                Log.d("MainActivity", "I just saw an beacon for the first time!");
            }

            @Override
            public void didExitRegion(Region region) {
                Log.d("MainActivity", "I no longer see an beacon");

            }

            @Override
            public void didDetermineStateForRegion(int state, Region region) {
                Log.d("MainActivity", "I have just switched from seeing/not seeing beacons: " + state);
            }
        });
